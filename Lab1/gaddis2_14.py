...
def calculate_principal_post_interest(principal, annual_interest_rate, compounds_per_year, years): #intialize function
...
#print(calculate_principal_post_interest(1, 10, 1, 2)) #passing arguments to the ...
